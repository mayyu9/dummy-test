...
var _DummpTestAppContainer = require('./DummpTestAppContainer');

var _DummpTestAppContainer2 = _interopRequireDefault(_DummpTestAppContainer);
...
var store = (0, _redux.createStore)((0, _redux.combineReducers)(_DummpTestAppContainer.reducers), (0, _redux.compose)((0, _redux.applyMiddleware)(sagaMiddleware)));

_DummpTestAppContainer.sagas.map(function (saga) {
...
var DummpTestAppApplication = function (_React$Component) {
  _inherits(DummpTestAppApplication, _React$Component);

  function DummpTestAppApplication() {
    _classCallCheck(this, DummpTestAppApplication);

    return _possibleConstructorReturn(this, (DummpTestAppApplication.__proto__ || Object.getPrototypeOf(DummpTestAppApplication)).apply(this, arguments));
  }

  _createClass(DummpTestAppApplication, [{
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_DummpTestAppContainer2.default, {
            patientId: patientId,
            service: service,
  ...
  return DummpTestAppApplication;
}(_react2.default.Component);

DummpTestAppApplication.propTypes = propTypes;

exports.default = DummpTestAppApplication;