...
var DummpTestAppView = function DummpTestAppView(props) {
  ...
  if (isLoading) {
    ...
    content = _react2.default.createElement(_terraClinicalErrorView2.default, { description: intl.formatMessage({ id: 'dummt-test-engine.dummp-test-app-failed-to-load' }), isGlyphHidden: true });
    ...
    content = _react2.default.createElement(_terraClinicalNoDataView2.default, { heading: intl.formatMessage({ id: 'dummt-test-engine.no-dummp-test-app' }), isGlyphHidden: true });
  }

  return _react2.default.createElement(
    _terraContentContainer2.default,
    { header: _react2.default.createElement(_terraClinicalHeader2.default, { title: intl.formatMessage({ id: 'dummt-test-engine.dummp-test-app' }) }) },
    content
  );
};
...
exports.default = (0, _reactIntl.injectIntl)(DummpTestAppView);