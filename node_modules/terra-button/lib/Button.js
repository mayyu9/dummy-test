...
var Button = function Button(_ref) {
  var children = _ref.children,
      ...
      customProps = _objectWithoutProperties(_ref, ['children', 'icon', 'isBlock', 'isCompact', 'isDisabled', 'isReversed', 'size', 'text', 'type', 'variant']);

  var attributes = _extends({}, customProps);
  var buttonText = text ? _react2.default.createElement(
    'span',
    { className: _Button2.default.text },
    text
  ) : null;

  attributes.className = cx(['button', variant, { 'is-disabled': isDisabled }, size, { block: isBlock }, { compact: isCompact }, attributes.className]);
