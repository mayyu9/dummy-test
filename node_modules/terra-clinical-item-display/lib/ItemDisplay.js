...
var ItemDisplay = function ItemDisplay(_ref) {
  ...
  var textClassNames = cx(['text', { 'is-truncated': isTruncated }, _defineProperty({}, '' + textStyle, textStyle)]);
  ...
  return _react2.default.createElement(
    'div',
    _extends({}, customProps, { className: cx('item-display', customProps.className) }),
    displayIcon,
