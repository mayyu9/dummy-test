...
var ItemView = function (_React$Component) {
  ...
  _createClass(ItemView, [{
    ...
    value: function render() {
      ...
      var viewClassNames = cx(['item-view', { 'is-truncated': isTruncated }, _defineProperty({}, '' + layout, layout), customProps.className]);
    ...
    value: function renderAccessory(accessory, accessoryAlignment) {
      ...
      if (accessory) {
        accessorySection = _react2.default.createElement(
          'div',
          { className: cx('accessory', _defineProperty({}, 'accessory-' + accessoryAlignment, accessoryAlignment)) },
          accessory
        );
      }
    ...
    value: function defaultEmphasisContentClassesFromIndexes(rowIndex, rowCount) {
      var contentSize = 'content-primarySize';
      var contentColor = 'content-primaryColor';
