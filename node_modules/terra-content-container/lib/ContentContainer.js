...
var _ContentContainer = require('./ContentContainer.scss');
...
var cx = _bind2.default.bind(_ContentContainer2.default);
...
var ContentContainer = function ContentContainer(_ref) {
  ...
  var contentLayoutClassNames = cx(['content-container', { fill: fill }, customProps.className]);
