  ...
  _createClass(ModalContent, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          customProps = _objectWithoutProperties(_props, ['ariaLabel', 'children', 'classNameModal', 'classNameOverlay', 'closeOnOutsideClick', 'onRequestClose', 'role', 'isFocused', 'isFullscreen', 'isScrollable']);

      var modalClassName = cx(['modal', { 'fixed-size': !isFullscreen }, { scrollable: isScrollable }, classNameModal]);
